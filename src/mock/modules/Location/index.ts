...
Mock.get(/\/location\/staff\/list/, locationStaffList);
Mock.get(/\/location\/car\/list/, locationCarList);
Mock.get(/\/location\/fence\/list/, locationFenceList);

function locationStaffList() {
  const data = [
    {
      name: '张三',
      title: '主任医师',
